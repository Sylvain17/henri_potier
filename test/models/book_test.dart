...
void main() {
  group('Test Book class public methods', () {
    test('check getSynopsisString', () {
      ...
      expect(book.getSynopsisString().split("\n\n").length, 3);
    });

    test('check containsSearchedText', () {
      Book book = Book.fromJson({
        "isbn": "c8fabf68-8374-48fe-a7ea-a00ccd07afff",
        "title": "Henri Potier à l'école des sorciers",
        "price": 35,
      ...
      expect(book.containsSearchedText("Henri Potier à l'école des sorciers"), true);
      expect(book.containsSearchedText("Henri Potier à l'école des sorcierss"), false);
      expect(book.containsSearchedText("henri potier a l'ecole des sorciers"), true);
      expect(book.containsSearchedText("henri potier a l'ecole des sorcierss"), false);

      expect(book.containsSearchedText("Après la mort"), true);
      expect(book.containsSearchedText("apres la mort"), true);
      expect(book.containsSearchedText("le jour des 11 ans"), true);
      expect(book.containsSearchedText("henri entre donc"), true);
    });
  });
}
